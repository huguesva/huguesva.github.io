...
- **Optimal Transport for Clustering and Dimensionality Reduction**. [Slides]({{ site.url }}/assets/pdf/slides/snekhorn_long.pdf). [Poster]({{ site.url }}/assets/pdf/posters/SNEkhorn.pdf). 
