...
I am a PhD student in the department of Mathematics ([UMPA](http://www.umpa.ens-lyon.fr/){:target="\_blank"}) of [Ecole Normale Supérieure de Lyon](http://www.ens-lyon.fr/){:target="\_blank"} supervised by [Aurélien Garivier](https://perso.ens-lyon.fr/aurelien.garivier/www.math.univ-toulouse.fr/_agarivie/index.html){:target="\_blank"} and [Titouan Vayer](https://tvayer.github.io/){:target="\_blank"} and in close collaboration with [Rémi Flamary](https://remi.flamary.com/index.fr.html){:target="\_blank"} and [Nicolas Courty](https://people.irisa.fr/Nicolas.Courty/){:target="\_blank"}.
...
<!-- More information may be found in my [CV]({{ site.url }}/assets/pdf/CV.pdf). -->