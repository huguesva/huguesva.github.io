...
Before starting my PhD, I received an [engineering degree](https://programmes.polytechnique.edu/cycle-ingenieur-polytechnicien/cycle-ingenieur-polytechnicien){:target="\_blank"} from [École polytechnique](https://www.polytechnique.edu/){:target="\_blank"} and a MSc degree ([MVA](https://www.master-mva.com/){:target="\_blank"}) from [ENS Paris-Saclay](https://ens-paris-saclay.fr/){:target="\_blank"}. More information may be found in my [CV]({{ site.url }}/assets/pdf/CV_Hugues.pdf).