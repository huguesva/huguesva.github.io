...
nav: false # Commented out - past teaching from PhD
nav_order: 5
---
...
See _e.g._ the following sheets: [Python]({{ site.url }}/assets/pdf/agreg/python.pdf), [s1]({{ site.url }}/assets/pdf/agreg/TD1.pdf), [s2]({{ site.url }}/assets/pdf/agreg/TD2.pdf), [s3]({{ site.url }}/assets/pdf/agreg/TD3.pdf), [s4]({{ site.url }}/assets/pdf/agreg/TD4.pdf), [s5]({{ site.url }}/assets/pdf/agreg/TD5.pdf), [s6]({{ site.url }}/assets/pdf/agreg/TD6.pdf).
